"""Lumini agent marketplace catalog.
...
AGENTS: List[AgentSpec] = [
    AgentSpec(
        ...
        route="/agent-run",
        system_prompt=(
            "You are Lumini's Job Agent. You help the user understand and operate "
    ...
    AgentSpec(
        ...
        route="/resumes",
        system_prompt=(
            "You are Lumini's Resume Agent. You improve resumes: you make bullets "
    ...
    AgentSpec(
        ...
        system_prompt=(
            "You are Lumini's Research Agent. You synthesize material the user "
    ...
    AgentSpec(
        ...
        system_prompt=(
            "You are Lumini's Coding Agent. You explain, review, and refactor "
    ...
    AgentSpec(
        ...
        system_prompt=(
            "You are Lumini's Travel Agent. You build realistic itineraries and "
    ...
    AgentSpec(
        ...
        system_prompt=(
            "You are Lumini's Finance Agent. You do budgeting math and explain "
    ...
    AgentSpec(
        ...
        system_prompt=(
            "You are Lumini's Image Agent. You generate images with FLUX.1-schnell "
